...
int main(int argc, char** argv)
{
	...
	try {
		...
		try { GeneratingList<EmployeeWage> empPro = writeRaw(emp, wrongSal); }
		catch (const string& msg){ cout << "ERROR: " << msg << endl; }

		cout << endl;
		cout << "********************************************" << endl
			<< "* Merging wrong salaries using Smart Pointers" << endl
			<< "********************************************" << endl;
		try { GeneratingList<EmployeeWage> empPro = writeSmart(emp, wrongSal); }
		catch (const string& msg) { cout << "ERROR: " << msg << std::endl; }
	...
	catch (...){ cout << "ERROR: Unknown error!"; }
